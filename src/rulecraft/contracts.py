"""Data contracts for Rulecraft v0.1.

All runtime logs are ref-centric. Do not persist raw PII/secrets in RunLog/TraceBundle.
"""
...
def is_pass(vr: ValidationResult) -> bool:
    return (vr.verdict == "PASS") and (vr.outcome != "FAIL")


def is_confirmed_pass(vr: ValidationResult) -> bool:
    return (vr.verdict == "PASS") and (vr.outcome == "OK")
